...
def test_converge_wc_pw(
    fresh_aiida_env, upload_potcar, mock_vasp, options, data_path, potcar_family_name, potcar_mapping
):
...
def test_converge_wc_on_failed(
    fresh_aiida_env, upload_potcar, mock_vasp, options, data_path, potcar_family_name, potcar_mapping
):
    """Test convergence workflow using mock code."""
    from aiida.engine import run
