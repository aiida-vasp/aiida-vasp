...
def test_parse_eigenval(eigenval_parser):
    ...
    result = eigenval_parser.get_quantity('eigenval-bands')
    bands = np.array([[[-1.439825, 2.964373, 2.964373, 2.964373, 7.254542, 7.254542, 7.254542, 11.451811, 11.670398, 11.670398]]])
    metadata = {
        0: [4, 4, 1, 1],
    ...
    assert np.allclose(result['bands'], bands)
