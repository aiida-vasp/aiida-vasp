...
class OptionHolder:
    ...
    def __init__(self, **kwargs):
        ...
        # This does not check if the keys are valid options - needs to be fixed in the future
        for key, value in kwargs.items():
            setattr(self, key, value)

    def _get_opt_dict(self):
        """Get a dictionary holding all the options"""
    ...
    def to_dict(self):
        ...
        Note this this does not detect additional attributes that is not a valid option
        such cases are just ignored. This should be fixed in the future.
        """
    ...
    def to_aiida_dict(self):
        ...
        return orm.Dict(dict=self.to_dict())
...
class RelaxOptions(OptionHolder):
    ...
    Options are defined as Property of the class
    """
