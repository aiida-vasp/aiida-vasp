...
def test_parse_eigenval(vasprun_parser):
    ...
    result = {}
    result['vrp_pdos'] = vasprun_parser.vrp_pdos
    result['vrp_tdos'] = vasprun_parser.vrp_tdos
    parser.get_quantity('dos', result)
