...
def main(potential_family, queue, code, computer):
    ...
    # set specific inputs for the relaxation WorkChain
    #inputs.relax = AttributeDict()
    #inputs.relax.convergence = AttributeDict()
    #inputs.relax.convergence.shape = AttributeDict()
    # inputs.relax.parameters = set_params_simple_no_encut()
    # set specific inputs for the convergence WorkChain
    ...
    #print(inputs.kpoints.get_kpoints())
