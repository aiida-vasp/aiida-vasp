...
def main(code_string, incar, kmesh, structure, potential_family, potential_mapping, options):
    ...
    selective_dynamics_data = DataFactory('array')()
    ...
    dynamics = AttributeDict()

    selective_dynamics_data.set_array(
        name='array', array=np.asarray([[1, 0, 0], [1, 0, 0]]))

    dynamics.selective_dynamics = selective_dynamics_data
...
if __name__ == '__main__':
    ...
    CODE_STRING = 'vasp-5.4.4-std-intel@moggie'
...
#    INCAR = {'vasp': {'prec': 'NORMAL', 'encut': 200, 'ediff': 1E-4, 'ialgo': 48, 'ismear': -5, 'sigma': 0.1}}
    INCAR = {'prec': 'NORMAL', 'encut': 200, 'ediff': 1E-4, 'ialgo': 48, 'ismear': -5, 'sigma': 0.1}
    ...
    OPTIONS.resources = {'tot_num_mpiprocs': 16, 'parallel_env': 'mpi'}
    OPTIONS.max_wallclock_seconds = 3600
    OPTIONS.withmpi = True
    OPTIONS.custom_scheduler_commands = '#$ -l slot_type=large'
