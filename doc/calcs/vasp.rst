...
This input only applies to :py:class:`AmnCalculation <aiida_vasp.calcs.amn.AmnCalculation>`, which is used to produce the
...
* :py:class:`Vasp2w90Calculation <aiida_vasp.calcs.vasp5.Vasp5Calculation>`
