...
There is a whole Family of Calculations for Vasp 5, offering varying degrees of flexibiliy.
...
An example::
   ...
   wannier_settings = ParameterData(dict={
      "num_bands": 24,
      "num_wann": 8,
      "projections": [
         ["In: s; px; py; pz"],
...
wannier_data
============
:py:class:`ArchiveData <aiida.orm.data.vasp.archive.ArchiveData>`
with a compressed tar archive of the files generated by wannier_setup, except for wannier90.win.
This input only applies to :py:class:`AmnCalculation <aiida.orm.calculation.job.vasp.amn.AmnCalculation>`, which is used to produce the
wannier90.amn projections file, using VASP2Wannier90.
...
Applies to:
* :py:class:`ScfCalculation <aiida.orm.calculation.job.vasp.scf.ScfCalculation>`
* :py:class:`Vasp5Calculation <aiida.orm.calculation.job.vasp.vasp5.Vasp5Calculation>`
* :py:class:`Vasp2w90Calculation <aiida.orm.calculation.job.vasp.vasp5.Vasp5Calculation>`
...
Applies to:
* :py:class:`NscfCalculations <aiida.orm.calculation.job.vasp.NscfCalculation`
* :py:class:`Vasp5Calculation <aiida.orm.calculation.job.vasp.vasp5.Vasp5Calculation>`
* :py:class:`Vasp2w90Calculation <aiida.orm.calculation.job.vasp.vasp5.Vasp5Calculation>`
...
Applies to:
* :py:class:`NscfCalculations <aiida.orm.calculation.job.vasp.NscfCalculation`
* :py:class:`AmnCalculation <aiida.orm.calculation.job.vasp.amn.AmnCalculation>`
* :py:class:`Vasp2w90Calculation <aiida.orm.calculation.job.vasp.vasp5.Vasp5Calculation>`
