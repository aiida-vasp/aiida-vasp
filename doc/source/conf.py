...
latex_documents = [
    (master_doc, 'AiiDA-VASP.tex', u'AiiDA-VASP Documentation',
     u'Espen Flage-Larsen, Atsushi Togo, Martin Callsen', 'manual'),
]
...
man_pages = [
    (master_doc, 'aiida-vasp', u'AiiDA-VASP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AiiDA-VASP', u'AiiDA-VASP Documentation',
     author, 'AiiDA-VASP', 'A plugin to enable usage of VASP in the AiiDA workflow engine.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'python': ('https://docs.python.org/', None), 'aiida': ('https://aiida.readthedocs.io/projects/aiida-core/en/latest/', None)}
