...
the {{ VaspInputGenerator }} class that allows you to create workflows using pre-define, customizable  templates for both calculations parameters and settings for code execution.
